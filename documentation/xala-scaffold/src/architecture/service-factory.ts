 ...
 */
export class ServiceFactory extends BaseServiceFactory implements IServiceFactory {
  ...
  private setupDefaultServices(): void {
    ...
    this.container.registerSingleton(
      'codeGenerator',
      () => new CodeGenerator(),
      ['templateEngine', 'templateRegistry', 'validatorComposite', 'fileSystemService'],
      {
...
export class ServiceFactoryBuilder {
   ...
   */
  configureContainer(configurator: (container: ServiceContainer) => void): this {
